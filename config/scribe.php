...
return [
    ...
    'description' => 'CoreBank414 API v4.15.01 - A comprehensive API for financial services, government payments, utilities, and value-added services in Rwanda.',
    ...
    'auth' => [
        ...
        'extra_info' => 'No authentication is required for this API version. All endpoints are accessible without authentication headers. For security, ensure requests are made over HTTPS and consider IP whitelisting for production environments.',
    ],
